...
// all blocks' seal as valid, though they still have to conform to the psch
// consensus rules.
...
// still have to conform to the psch consensus rules.
...
// they still have to conform to the psch consensus rules.
