...
// mapped from textual names used in the tests below to actual psch private
...
// address retrieves the psch address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the psch address
