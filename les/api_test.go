...
import (
	...
	"github.com/petercastron/PSCH/p2p/simulations"
	"github.com/petercastron/PSCH/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	psch, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, psch, &config)
	if err != nil {
		return nil, err
	}
	return psch, nil
