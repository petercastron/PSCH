...
import (
	...
	"github.com/petercastron/PSCH/common/bitutil"
	"github.com/petercastron/PSCH/light"
)

const (
	// bloomServiceThreads is the number of goroutines used globally by an psch
...
func (eth *Lightpsch) startBloomHandlers(sectionSize uint64) {
