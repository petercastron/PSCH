...
import (
	...
	"github.com/petercastron/PSCH/internal/testlog"
	"github.com/petercastron/PSCH/log"
	"github.com/petercastron/PSCH/p2p/discover/v5wire"
...
// This test checks that opschoing PING calls work.
...
// This test checks that opschoing FINDNODE calls work and multiple NODES
...
// This test checks that opschoing TALKREQ calls work.
...
// It runs the UDPv5 transport on a virtual socket and allows testing opschoing packets.
