...
// NewID calculates the psch fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the psch fork ID from an existing chain instance.
