...
pruning. Remember don't start the psch. without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "psch. snapshot prune-state --help" for more details.
`
