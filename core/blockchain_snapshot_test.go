...
// It can be used for testing that restart psch. normally.
...
// It can be used for testing that restart psch. after the crash.
...
// Tests a psch. restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a psch. was crashed and restarts with a broken snapshot. In this case the
...
// Tests a psch. was crashed and restarts with a broken snapshot. In this case
...
// Tests a psch. was running with snapshot enabled. Then restarts without
...
// Tests the psch. was running with snapshot enabled and resetHead is applied.
...
// Tests the psch. was running with a complete snapshot and then imports a few
