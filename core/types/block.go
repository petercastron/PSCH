...
// Package types contains data types related to psch consensus.
package types
...
// Header represents a block header in the psch blockchain.
type Header struct {
...
// Block represents an entire block in the psch blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the psch RLP block format.
