...
# 1. install psch for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for psch
# 5. create psch, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable psch_SOCKET
...
!define GROUPNAME "psch"
!define APPNAME "psch"
!define DESCRIPTION "Official Go implementation of the psch protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since psch is installed global
