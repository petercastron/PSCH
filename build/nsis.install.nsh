Name "psch ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/petercastron/PSCH/issues"
!define UPDATEURL "https://github.com/petercastron/PSCH/releases"
!define ABOUTURL "https://github.com/petercastron/PSCH#psch"
...
# Install psch binary
Section "psch" psch_IDX
  SetOutPath $INSTDIR
  file {{.psch}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\psch.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\psch.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "psch incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "psch opschoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "psch UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "psch incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\psch.exe" "" "" "psch" 30303 "" "" ""
  SimpleFC::AdvAddRule "psch opschoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\psch.exe" "" "" "psch" "" 30303 "" ""
  SimpleFC::AdvAddRule "psch UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\psch.exe" "" "" "psch" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "psch_SOCKET" "R" "HKLM" "\\.\pipe\psch.ipc"
  ${EnvVarUpdate} $0 "psch_SOCKET" "A" "HKLM" "\\.\pipe\psch.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${psch_IDX}
    SectionGetSize ${psch_IDX} $0
