...
func (mc *mockCaller) CallContract(ctx context.Context, call psch.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call psch.CallMsg) ([]byte, error) {
