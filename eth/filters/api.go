...
// information related to the psch protocol such als blocks, transactions and logs.
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(psch.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as psch.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria psch.FilterQuery
...
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	...
	logsSub, err := api.events.SubscribeLogs(psch.FilterQuery(crit), logs)
	if err != nil {
		return "", err
	}
