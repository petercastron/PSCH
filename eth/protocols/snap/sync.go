...
import (
	...
	"github.com/petercastron/PSCH/p2p/msgrate"
...
// Syncer is an psch account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the psch state over the
// snap protocol.
