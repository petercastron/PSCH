...
// Defaults contains default settings for use on the psch main net.
var Defaults = Config{
...
type Config struct {
	...
	// If nil, the psch main net block is used.
	...
	LightEgress        int  `toml:",omitempty"` // Opschoing bandwidth limit for light servers
