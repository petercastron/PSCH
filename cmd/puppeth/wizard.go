...
type wizard struct {
	...
	services map[string][]string   // psch services known to be running on servers
...
// converts it to an psch address. If an empty line is entered, the default
// value is returned.
