...
// setting up a new or managing an existing psch private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your psch private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new psch network down to  |")
	...
	log.Info("Administering psch network", "name", w.network)
