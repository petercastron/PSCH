...
// importGenesis imports a psch genesis spec into puppeth.
...
func (w *wizard) manageGenesis() {
	...
	case "2":
		...
		// Export the native genesis spec used by puppeth and psch
		...
		// Export the genesis spec used by Aleth (formerly C++ psch)
		...
		// Export the genesis spec used by Harmony (formerly pschJ)
