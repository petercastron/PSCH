...
// This file is part of psch.
//
// psch is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// psch is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
// GNU General Public License for more details.
//
// You should have received a copy of the GNU General Public License
// along with psch. If not, see <http://www.gnu.org/licenses/>.

// Package utils contains internal helper functions for psch commands.
package utils
...
import (
	...
	"github.com/petercastron/PSCH/accounts/keystore"
	"github.com/petercastron/PSCH/common"
	"github.com/petercastron/PSCH/common/fdlimit"
	"github.com/petercastron/PSCH/consensus"
	"github.com/petercastron/PSCH/consensus/alien"
	"github.com/petercastron/PSCH/consensus/clique"
	"github.com/petercastron/PSCH/consensus/ethash"
	"github.com/petercastron/PSCH/core"
	"github.com/petercastron/PSCH/core/rawdb"
	"github.com/petercastron/PSCH/core/vm"
	"github.com/petercastron/PSCH/crypto"
	"github.com/petercastron/PSCH/eth"
	"github.com/petercastron/PSCH/eth/downloader"
	"github.com/petercastron/PSCH/eth/ethconfig"
	"github.com/petercastron/PSCH/eth/gasprice"
	"github.com/petercastron/PSCH/eth/tracers"
	"github.com/petercastron/PSCH/ethdb"
	"github.com/petercastron/PSCH/ethstats"
	"github.com/petercastron/PSCH/graphql"
	"github.com/petercastron/PSCH/internal/ethapi"
	"github.com/petercastron/PSCH/internal/flags"
	"github.com/petercastron/PSCH/les"
	"github.com/petercastron/PSCH/log"
	"github.com/petercastron/PSCH/metrics"
	"github.com/petercastron/PSCH/metrics/exp"
	"github.com/petercastron/PSCH/metrics/influxdb"
	"github.com/petercastron/PSCH/miner"
	"github.com/petercastron/PSCH/node"
	"github.com/petercastron/PSCH/p2p"
	"github.com/petercastron/PSCH/p2p/enode"
	"github.com/petercastron/PSCH/p2p/nat"
	"github.com/petercastron/PSCH/p2p/netutil"
...
var (
	...
	LightEgressFlag = cli.IntFlag{
		Name:  "light.egress",
		Usage: "Opschoing bandwidth limit for serving light clients (kilobytes/sec, 0 = unlimited)",
...
func MakeDataDir(ctx *cli.Context) string {
	if path := ctx.GlobalString(DataDirFlag.Name); path != "" {
		if ctx.GlobalBool(TestnetFlag.Name) {
			// Maintain compatibility with older psch configurations storing the
...
// for psch and returns half of the allowance to assign to the database.
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `psch account list`)")
	log.Warn("-------------------------------------------------------------------")
...
// RegisterEthService adds an psch client to the stack.
...
func RegisterEthService(stack *node.Node, cfg *ethconfig.Config) (ethapi.Backend, *eth.Ethereum) {
	if cfg.SyncMode == downloader.LightSync {
		...
		if err != nil {
			Fatalf("Failed to register the psch service: %v", err)
		}
...
// RegisterEthStatsService configures the psch Stats daemon and adds it to
// the given node.
func RegisterEthStatsService(stack *node.Node, backend ethapi.Backend, url string) {
	if err := ethstats.New(stack, backend, backend.Engine(), url); err != nil {
		Fatalf("Failed to register the psch Stats service: %v", err)
	}
}
...
// new format.
//
// e.g. psch account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// psch --keystore /tmp/mykeystore --lightkdf account new
//
