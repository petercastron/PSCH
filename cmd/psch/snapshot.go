...
import (
	...
	"github.com/petercastron/PSCH/core/state/snapshot"
...
var (
	snapshotCommand = cli.Command{
		...
		Subcommands: []cli.Command{
			{
				Name:      "prune-state",
				Usage:     "Prune stale psch state data based on the snapshot",
				ArgsUsage: "<root>",
				...
				Description: `
psch snapshot prune-state <state-root>
...
during the use of psch, please also specify it here for correct deletion. Otherwise
...
`,
			},
			{
				...
				Description: `
psch snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Description: `
psch snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Description: `
psch snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'psch dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'psch dump', but uses the snapshots
