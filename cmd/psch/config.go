...
import (
	...
	"github.com/petercastron/PSCH/eth/catalyst"
...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = "psch.ipc"
	return cfg
}

// makeConfigNode loads psch configuration and creates a blank node instance.
...
// makeFullNode loads psch configuration and creates the psch backend.
func makeFullNode(ctx *cli.Context) (*node.Node, ethapi.Backend) {
	...
	// Add the psch Stats daemon if requested.
	if cfg.Ethstats.URL != "" {
