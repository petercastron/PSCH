...
import (
	...
	"github.com/petercastron/PSCH/signer/core"
	"github.com/petercastron/PSCH/signer/fourbyte"
	"github.com/petercastron/PSCH/signer/rules"
	"github.com/petercastron/PSCH/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage psch account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
