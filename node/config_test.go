...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "psch.ipc", false, filepath.Join(os.TempDir(), "psch.ipc")},
		{"data", "psch.ipc", false, "data/psch.ipc"},
		{"data", "./psch.ipc", false, "./psch.ipc"},
		{"data", "/psch.ipc", false, "/psch.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "psch.ipc", true, `\\.\pipe\psch.ipc`},
		{"data", "psch.ipc", true, `\\.\pipe\psch.ipc`},
		{"data", `\\.\pipe\psch.ipc`, true, `\\.\pipe\psch.ipc`},
	}
