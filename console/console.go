...
import (
	...
	"github.com/petercastron/PSCH/internal/jsre/deps"
	"github.com/petercastron/PSCH/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute psch requests through
...
// Welcome show summary of current psch instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the psch JavaScript console!\n\n"

	// Print some generic psch metadata
