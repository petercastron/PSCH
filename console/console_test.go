...
import (
	...
	"github.com/petercastron/PSCH/internal/jsre"
...
func newTester(t *testing.T, confOverride func(*ethconfig.Config)) *tester {
	...
	// Create a networkless protocol stack and start an psch service within
	...
	if err != nil {
		t.Fatalf("failed to register psch protocol: %v", err)
	}
