...
// Package graphql provides a GraphQL interface to psch node data.
package graphql
...
// Account represents an psch account at a particular block.
type Account struct {
...
// Transaction represents an psch transaction.
...
// Block represents an psch block.
...
type CallData struct {
	From     *common.Address // The psch address the call is from.
	To       *common.Address // The psch address the call is to.
